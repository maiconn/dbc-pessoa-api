...
import com.dbc.pessoaapi.entity.CargoEntity;
...
public class TokenService {
    ...
    private static final String CARGOS_CLAIN = "cargos";
    ...
    public UsernamePasswordAuthenticationToken isValid(String token) {
        if (token != null) {
            ...
            if (user != null) {
                List<String> cargos = body.get(CARGOS_CLAIN, List.class);
